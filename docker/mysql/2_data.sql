INSERT
IGNORE INTO TblQuestion (answer, category, scoringType, text, explanation)
VALUES (21105172, 'TECH', 1,
    'How many questions were there on Stack Overflow in 2025',
    'There are approximately 24,105,172 questions on Stack Overflow'),
(700, 'JOKE', 1,
...
(40000000, 'TECH', 1,
    'How many users did GitHub have in 2023',
    'There were approximately 100,000,000 GitHub users in 2023'),
(66, 'SPACE', 0,
...
(3363840000, 'BIOLOGY', 1,
    'How many human heartbeats occur in an average lifetime',
    'If you live to be 80 years old, your heart would have beaten approximately 3,363,840,000 times'),
(1000000000000, 'BIOLOGY', 1,
    'What is the estimated number of distinct odors the average human nose can detect',
    'Researchers at Rockefeller University estimate that the average human nose can detect approximately 1 trillion distinct odors'),
(7500000000000000000, 'GENERAL', 1,
    'Approximately how many grains of sand are there on all the beaches in the world combined',
    'Scientists estimate that there are approximately 7.5 quintillion grains of sand on all the beaches in the world combined'),
(14000, 'BIOLOGY', 1,
    'What is the total length in kilometers of all the blood vessels in an average adult human body',
    'Recent studies estimate that the total length of all the blood vessels in an average adult human body is about 14,000 kilometers, though it is often misrepresented as 100,000km due to an old study from 1922'),
(12149, 'SPACE', 1,
    'How many active satellites are currently orbiting Earth in 2025',
    'The satellite tracking website “Orbiting Now” lists 12,149 active satellites in various Earth orbits'),
(622, 'SPACE', 0,
    'How many humans have been to space as of 2022',
    'As of May 6th, 2022, a total of 622 people from 38 countries have gone into space.'),
(879, 'SPACE', 0,
    'What is the maximum number of days any one human has spent in space',
...
(29000, 'SPACE', 1,
    'How many person-days have humans spent in space in total as of 2022',
    'Space travelers have spent over 29,000 person-days (or a cumulative total of over 77 years) in space'),
(6000, 'GENERAL', 1,
    'What is the average number of lightning strikes that occur worldwide per minute',
    'According to the CDC there are about 6,000 lightning strikes per minute'),
(1386000000, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of all the oceans on Earth',
    'The estimated volume of all the Oceans on Earth is approximately 1,386,000,000 cubic kilometers'),
(669880000, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of the Pacific Ocean',
    'The estimated volume of the Pacific Ocean is approximately 669,880,000 cubic kilometers'),
(310410900, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of the Atlantic Ocean',
    'The estimated volume of the Atlantic Ocean is approximately 310,410,900 cubic kilometers'),
(264000000, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of the Indian Ocean',
    'The estimated volume of the Indian Ocean is approximately 264,000,000 cubic kilometers'),
(71800000, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of the Southern Ocean',
    'The estimated volume of the Southern Ocean is approximately 71,800,000 cubic kilometers'),
(18750000, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of the Arctic Ocean',
    'The estimated volume of the Arctic Ocean is approximately 18,750,000 cubic kilometers'),
(176400, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of all the lakes on Earth',
    'The estimated volume of all the lakes on Earth is approximately 176,400 cubic kilometers'),
(12900, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of all the water in the atmosphere on Earth',
    'The estimated volume of all the water in the atmosphere is approximately 12900 cubic kilometers'),
(24364000, 'GEOLOGY', 1,
    'In cubic kilometers, what is the estimated volume of all the ice and snow on Earth',
    'The estimated volume of all the ice and snow on Earth is approximately 24,364,000 cubic kilometers'),
(28829, 'LITERATURE', 1,
    'How many unique words are there in the works of William Shakespeare',
    'There are 28,829 unique word forms, and 12,493 occur only once'),
(171000000000, 'BIOLOGY', 1,
    'What is the approximate number of individual cells in the human brain',
    'There are roughly 171 billion cells in the average male brain')
